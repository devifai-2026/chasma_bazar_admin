...
const Products = () => {
  ...
  const dummyProducts = [
    { id: 1, name: 'Wireless Headphones', category: 'Electronics', price: '$99.99', stock: 45, status: 'In Stock', image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=150&h=150&fit=crop', isDummy: true },
    { id: 2, name: 'Running Shoes', category: 'Sports', price: '$129.99', stock: 23, status: 'Low Stock', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=150&h=150&fit=crop', isDummy: true },
    { id: 3, name: 'Coffee Maker', category: 'Home & Kitchen', price: '$79.99', stock: 0, status: 'Out of Stock', image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=150&h=150&fit=crop', isDummy: true },
    { id: 4, name: 'Smart Watch', category: 'Electronics', price: '$199.99', stock: 67, status: 'In Stock', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=150&h=150&fit=crop', isDummy: true },
    { id: 5, name: 'Backpack', category: 'Fashion', price: '$49.99', stock: 89, status: 'In Stock', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=150&h=150&fit=crop', isDummy: true },
    { id: 6, name: 'Desk Lamp', category: 'Home & Office', price: '$34.99', stock: 12, status: 'Low Stock', image: 'https://images.unsplash.com/photo-1507473885765-e6ed057f782c?w=150&h=150&fit=crop', isDummy: true },
  ]
  ...
  const deleteProduct = (id) => {
    if (window.confirm('Are you sure you want to delete this product?')) {
      ...
      if (productToDelete?.isDummy) {
        alert('Cannot delete demo products. Add your own products to manage them.')
        return
      }
  ...
  const calculateAveragePrice = () => {
    ...
    const productsToCalculate = userProducts.length > 0 ? userProducts : products
          ...
          <div className="mx-auto max-w-7xl">
                    ...
                    {products.length === 0 ? (
                      <tr>
                        <td colSpan="6" className="px-6 py-12 text-center">
                          <div className="text-gray-500">No products found. Click "Add Product" to get started.</div>
                        </td>
                      </tr>
                    ) : (
                        ...
                        >
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <div className="ml-4">
                                ...
                                <div className="text-sm text-gray-500">ID: #{product.id.toString().padStart(3, '0')}</div>
                              </div>
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <span className="ml-3 text-sm text-gray-600">{product.stock} units</span>
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div className="flex items-center space-x-2">
                              ...
                              <button 
                                className={`p-1 ${product.isDummy ? 'text-gray-400 cursor-not-allowed' : 'text-green-600 hover:text-green-800'}`} 
                                title={product.isDummy ? "Cannot edit demo products" : "Edit"}
                                disabled={product.isDummy}
                              >
                                <PencilIcon className="h-5 w-5" />
                              </button>
                              <button 
                                className={`p-1 ${product.isDummy ? 'text-gray-400 cursor-not-allowed' : 'text-red-600 hover:text-red-800'}`} 
                                title={product.isDummy ? "Cannot delete demo products" : "Delete"}
                                onClick={product.isDummy ? undefined : () => deleteProduct(product.id)}
                                disabled={product.isDummy}
                              >
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                ...
                <button className="px-3 py-1 border border-gray-300 rounded-lg hover:bg-gray-50" disabled={products.length <= 10}>
                  Next
                </button>
              </div>
            </div>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="text-sm text-yellow-600 mt-1">Need attention</div>
              </div>
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="text-sm text-blue-600 mt-1">+5.2% from last month</div>
              </div>
            </div>
          </div>
        </main>
